...
public final class MultipleContextsUnitTest {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        for (int i = 2; i < apps.length; i++) {
            ...
            final AtomicReference<Boolean> called1 = new AtomicReference(false);
            final AtomicReference<Boolean> called2 = new AtomicReference(false);
            final int num1 = createSENumber;
            SunToolkit.postEvent(app, new InvocationEvent(new Object(),
                    new Runnable() {
                @Override
                public void run() {
    ...
    private static Thread testThread(final int index) {
