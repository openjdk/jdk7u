...
public class AlgorithmIdEqualsHashCode {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AlgorithmParameters algParams2 =
            AlgorithmParameters.getInstance("EC");
        algParams1.init(new ECGenParameterSpec("secp521r1"));
        algParams2.init(new ECGenParameterSpec("secp384r1"));
        ai1 = new AlgorithmId(AlgorithmId.EC_oid, algParams1);
        ai2 = new AlgorithmId(AlgorithmId.EC_oid, algParams2);
        if (ai1.equals(ai2)) {
