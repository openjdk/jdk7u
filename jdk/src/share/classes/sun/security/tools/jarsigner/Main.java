            ...
            while (entries.hasMoreElements()) {
                ...
                try {
                            if (name.endsWith(".SF")) {
                                ...
                                if (!found) {
                                    if (!unparsableSignatures.containsKey(alias)) {
            ...
            if (!digestMap.isEmpty()
                ...
                for (String s : sigMap.keySet()) {
                    if (!digestMap.containsKey(s) &&
                        !unparsableSignatures.containsKey(s)) {
                ...
                for (String s : digestMap.keySet()) {
                    ...
                    if (p7 != null) {
                        ...
                        if (!unparsableSignatures.containsKey(s)) {
                            unparsableSignatures.put(s, String.format(
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    pkixParameters = new PKIXBuilderParameters(anchors, null);
