...
// Return register stack slot addr at which currently interpreted methodOop is found.
inline methodOop* frame::interpreter_frame_method_addr() const                {
  return (methodOop*) &(get_ijava_state()->method);
}
inline constantPoolCacheOop* frame::interpreter_frame_cpoolcache_addr() const {
  return (constantPoolCacheOop*) &(get_ijava_state()->cpoolCache);
}
inline constantPoolCacheOop* frame::interpreter_frame_cache_addr() const {
  return (constantPoolCacheOop*) &(get_ijava_state()->cpoolCache);
}
...
inline void frame::interpreter_frame_set_cpcache(constantPoolCacheOop cp)     { *frame::interpreter_frame_cpoolcache_addr() = cp; }
