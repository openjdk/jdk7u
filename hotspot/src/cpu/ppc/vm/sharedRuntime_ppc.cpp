...
static void gen_i2c_adapter(MacroAssembler *masm,
  ...
  __ ld(R12_scratch2, in_bytes(methodOopDesc::from_compiled_offset()), R19_method);
...
AdapterHandlerEntry* SharedRuntime::generate_i2c2i_adapters(MacroAssembler *masm,
  ...
  __ ld(ic_klass, compiledICHolderOopDesc::holder_klass_offset(), ic);
  ...
  // Extract method oop from inline cache, verified entry point needs it.
  __ ld(R19_method, compiledICHolderOopDesc::holder_method_offset(), ic);
...
nmethod *SharedRuntime::generate_native_wrapper(MacroAssembler *masm,
  ...
  __ load_heap_oop_not_null(receiver_klass, oopDesc::klass_offset_in_bytes(), R3_ARG1);
  ...
  if (method_is_static && !is_critical_native) {
    __ set_oop_constant(JNIHandles::make_local(Klass::cast(method->method_holder())->java_mirror()),
...
RuntimeStub* SharedRuntime::generate_resolve_blob(address destination, const char* name) {
  ...
  __ ld(R19_method, in_bytes(JavaThread::vm_result_offset()), R16_thread);
