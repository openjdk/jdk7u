...
VtableStub* VtableStubs::create_vtable_stub(int vtable_index) {
  ...
  __ load_heap_oop_with_trap_null_check(rcvr_klass, oopDesc::klass_offset_in_bytes(), R3);
...
VtableStub* VtableStubs::create_itable_stub(int vtable_index) {
  ...
  // We might implicit NULL fault here.
  address npe_addr = __ pc(); // npe = null pointer exception
  __ load_heap_oop_with_trap_null_check(rcvr_klass, oopDesc::klass_offset_in_bytes(), R3_ARG1);
  ...
  assert(!MacroAssembler::needs_explicit_null_check(in_bytes(methodOopDesc::from_compiled_offset())), "sanity");
