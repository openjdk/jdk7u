...
#define CPU_PPC_VM_TEMPLATETABLE_PPC_64_HPP
  ...
  static void prepare_indy_invoke(int byte_no, Register Rmethod, Register Rret_addr, Register Runextended_SP, Register Rmethod_type, Register Rflags, Register Rrecv, Register Rscratch1);
